<template>
  <aside class="z-20 hidden w-64 overflow-y-auto bg-blue-900 md:block flex-shrink-0">
      ...
      <ul class="mt-6">
        ...
        <li class="relative px-6 py-3">
          <button @click="showingTwoLevelMenu = !showingTwoLevelMenu"
            ...
            <ul v-show="showingTwoLevelMenu || route('courses.index') || route('courses.create')" class="p-2 mt-2 space-y-2 overflow-hidden text-sm font-medium text-gray-500 rounded-md shadow-inner bg-gray-50"
                aria-label="submenu">
